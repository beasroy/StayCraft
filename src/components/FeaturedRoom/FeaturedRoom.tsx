...
const FeaturedRoom: FC<Props> = props => {
    ...
    return (
        <section className='flex md:flex-row flex-col px-4 py-10 items-center justify-center lg:w-4/5 gap-12 container mx-auto '>
            ...
            <div className='md:py-10 md:w-1/2 text-left'>
                ...
                <div className='flex flex-col md:flex-row md:items-center justify-between mt-5'>
                    <div className='flex mb-3 md:mb-0'>
                        <div className='flex gap-4 flex-col items-center justify-center mr-4 md:mr-10'>
                            <p className='text-xs lg:text-xl text-right'>Start From</p>
                    ...
                    <Link
                        ...
                        className='border h-fit text-center border-tertiary-dark text-tertiary-dark px-3 py-2 lg:py-3 lg:px-4 rounded-2xl font-bold lg:text-xl'
                    >
                        More Details
                    </Link>
                </div>
